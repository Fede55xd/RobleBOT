...
additionalText = '🎥'}
let captionvid = `ও 𝙏𝙄𝙏𝙐𝙇𝙊:
»  ${yt_play[0].title}
﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘
ও ENVIANDO.. ${additionalText}, AGUARDE UN MOMENTO`
